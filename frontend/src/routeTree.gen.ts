...
const AuthenticatedSettingsMenuLazyImport = createFileRoute(
  '/_authenticated/settings/menu',
)()
...
const AuthenticatedSettingsMenuLazyRoute =
  AuthenticatedSettingsMenuLazyImport.update({
    id: '/menu',
    path: '/menu',
    getParentRoute: () => AuthenticatedSettingsRouteLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/settings/menu.lazy').then((d) => d.Route),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/settings/menu': {
      id: '/_authenticated/settings/menu'
      path: '/menu'
      fullPath: '/settings/menu'
      preLoaderRoute: typeof AuthenticatedSettingsMenuLazyImport
      parentRoute: typeof AuthenticatedSettingsRouteLazyImport
    }
    '/_authenticated/settings/notifications': {
...
interface AuthenticatedSettingsRouteLazyRouteChildren {
  ...
  AuthenticatedSettingsMenuLazyRoute: typeof AuthenticatedSettingsMenuLazyRoute
...
const AuthenticatedSettingsRouteLazyRouteChildren: AuthenticatedSettingsRouteLazyRouteChildren =
  {
    ...
    AuthenticatedSettingsDisplayLazyRoute:
      AuthenticatedSettingsDisplayLazyRoute,
    AuthenticatedSettingsMenuLazyRoute: AuthenticatedSettingsMenuLazyRoute,
...
export interface FileRoutesByFullPath {
  ...
  '/settings/menu': typeof AuthenticatedSettingsMenuLazyRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/settings/menu': typeof AuthenticatedSettingsMenuLazyRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/settings/menu": {
      "filePath": "_authenticated/settings/menu.lazy.tsx",
      "parent": "/_authenticated/settings"
    },
    "/_authenticated/settings/notifications": {
